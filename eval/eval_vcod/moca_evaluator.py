...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        # default=["Smeasure", "wFmeasure", 'meanEm', 'MAE', 'meanDice', 'meanIoU'], # 原始默认
        default=["Smeasure", "wFmeasure", "MAE", "adpEm", "meanEm", "maxEm", "adpFm", "meanFm", "maxFm",
                 "meanDice", "meanIoU"],
    ...
    txt_save_path = 'E:/Projects/EPFlow/result/eval-result/{}/'.format(opt.model_typename)
